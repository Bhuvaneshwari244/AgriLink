...
type TranslationKeys = {
  ...
  mandi: { title: string; search: string; state: string; commodity: string; minPrice: string; maxPrice: string; modalPrice: string; nearby: string; all: string; crop: string; crops: string; tapExpand: string; showingNearby: string; markets: string; rates: string };
  transport: { title: string; cropType: string; quantity: string; pickup: string; destination: string; submit: string; whatsapp: string; call: string; requestPickup: string; fillDetails: string; placeholderCrop: string; placeholderQty: string; placeholderPickup: string; placeholderDest: string };
...
export const translations: Record<string, TranslationKeys> = {
  ...
  hi: {
    ...
    mandi: { title: "मंडी भाव", search: "गाँव, जिला, या मंडी खोजें...", state: "राज्य", commodity: "फसल", minPrice: "न्यूनतम मूल्य", maxPrice: "अधिकतम मूल्य", modalPrice: "मॉडल मूल्य", nearby: "मेरे आसपास", all: "सभी", crop: "फसल", crops: "फसलें", tapExpand: "और फसलें — विस्तार करें", showingNearby: "आपके स्थान के निकटतम बाज़ार", markets: "बाज़ार", rates: "भाव" },
