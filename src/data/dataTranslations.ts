...
const dataTranslations: Record<string, DataTranslations> = {
  en: {
    ...
    cropNames: {
      ...
      Tomato: "Tomato", Potato: "Potato", Onion: "Onion", "Brinjal (Eggplant)": "Brinjal (Eggplant)", "Chilli (Green & Red)": "Chilli (Green & Red)", "Okra (Bhindi/Lady Finger)": "Okra (Bhindi/Lady Finger)", Cabbage: "Cabbage", Cauliflower: "Cauliflower", Carrot: "Carrot", Radish: "Radish", "Spinach (Palak)": "Spinach (Palak)", "Bottle Gourd (Lauki)": "Bottle Gourd (Lauki)", "Bitter Gourd (Karela)": "Bitter Gourd (Karela)", "Ridge Gourd (Turai)": "Ridge Gourd (Turai)", Pumpkin: "Pumpkin", Cucumber: "Cucumber", "French Beans": "French Beans", "Drumstick (Moringa)": "Drumstick (Moringa)", "Sweet Potato": "Sweet Potato", Lettuce: "Lettuce", Broccoli: "Broccoli", "Capsicum (Bell Pepper)": "Capsicum (Bell Pepper)", Beetroot: "Beetroot", "Snake Gourd": "Snake Gourd", "Ash Gourd": "Ash Gourd", "Cluster Bean (Guar)": "Cluster Bean (Guar)", "Taro (Arbi)": "Taro (Arbi)",
      Mango: "Mango", Banana: "Banana", Papaya: "Papaya", Guava: "Guava", Pomegranate: "Pomegranate", Grapes: "Grapes", Apple: "Apple", "Orange (Nagpur/Kinnow)": "Orange (Nagpur/Kinnow)", "Lemon/Lime": "Lemon/Lime", Watermelon: "Watermelon", "Sapota (Chikoo)": "Sapota (Chikoo)", Jackfruit: "Jackfruit", Pineapple: "Pineapple", Strawberry: "Strawberry", Litchi: "Litchi", "Amla (Indian Gooseberry)": "Amla (Indian Gooseberry)", "Dragon Fruit": "Dragon Fruit",
      "Turmeric (Haldi)": "Turmeric (Haldi)", "Ginger (Adrak)": "Ginger (Adrak)", "Garlic (Lehsun)": "Garlic (Lehsun)", "Coriander (Dhaniya)": "Coriander (Dhaniya)", "Cumin (Jeera)": "Cumin (Jeera)", "Fenugreek (Methi)": "Fenugreek (Methi)", "Black Pepper": "Black Pepper", Cardamom: "Cardamom", Clove: "Clove", Cinnamon: "Cinnamon", "Fennel (Saunf)": "Fennel (Saunf)", Saffron: "Saffron",
      "Cotton (Kapas)": "Cotton (Kapas)", Sugarcane: "Sugarcane", Tobacco: "Tobacco", Jute: "Jute",
      Tea: "Tea", Coffee: "Coffee", Rubber: "Rubber", "Coconut": "Coconut", "Oil Palm": "Oil Palm", "Arecanut (Supari)": "Arecanut (Supari)", Cocoa: "Cocoa", Cashew: "Cashew", Vanilla: "Vanilla", "Betel Vine (Paan)": "Betel Vine (Paan)", "Tapioca (Cassava)": "Tapioca (Cassava)",
    },
  ...
  hi: {
    ...
    cropNames: {
      ...
      Tomato: "टमाटर", Potato: "आलू", Onion: "प्याज", "Brinjal (Eggplant)": "बैंगन", "Chilli (Green & Red)": "मिर्च", "Okra (Bhindi/Lady Finger)": "भिंडी", Cabbage: "पत्तागोभी", Cauliflower: "फूलगोभी", Carrot: "गाजर", Radish: "मूली", "Spinach (Palak)": "पालक", "Bottle Gourd (Lauki)": "लौकी", "Bitter Gourd (Karela)": "करेला", "Ridge Gourd (Turai)": "तोरई", Pumpkin: "कद्दू", Cucumber: "खीरा", "French Beans": "फ्रेंच बीन्स", "Drumstick (Moringa)": "सहजन (मोरिंगा)", "Sweet Potato": "शकरकंद", Lettuce: "सलाद पत्ता", Broccoli: "ब्रोकली", "Capsicum (Bell Pepper)": "शिमला मिर्च", Beetroot: "चुकंदर", "Snake Gourd": "चचिंडा", "Ash Gourd": "पेठा", "Cluster Bean (Guar)": "ग्वार फली", "Taro (Arbi)": "अरबी",
      Mango: "आम", Banana: "केला", Papaya: "पपीता", Guava: "अमरूद", Pomegranate: "अनार", Grapes: "अंगूर", Apple: "सेब", "Orange (Nagpur/Kinnow)": "संतरा (नागपुर/किन्नू)", "Lemon/Lime": "नींबू", Watermelon: "तरबूज", "Sapota (Chikoo)": "चीकू", Jackfruit: "कटहल", Pineapple: "अनानास", Strawberry: "स्ट्रॉबेरी", Litchi: "लीची", "Amla (Indian Gooseberry)": "आंवला", "Dragon Fruit": "ड्रैगन फ्रूट",
      "Turmeric (Haldi)": "हल्दी", "Ginger (Adrak)": "अदरक", "Garlic (Lehsun)": "लहसुन", "Coriander (Dhaniya)": "धनिया", "Cumin (Jeera)": "जीरा", "Fenugreek (Methi)": "मेथी", "Black Pepper": "काली मिर्च", Cardamom: "इलायची", Clove: "लौंग", Cinnamon: "दालचीनी", "Fennel (Saunf)": "सौंफ", Saffron: "केसर",
      "Cotton (Kapas)": "कपास", Sugarcane: "गन्ना", Tobacco: "तम्बाकू", Jute: "जूट/पटसन",
      Tea: "चाय", Coffee: "कॉफी", Rubber: "रबड़", Coconut: "नारियल", "Oil Palm": "ऑयल पाम", "Arecanut (Supari)": "सुपारी", Cocoa: "कोको", Cashew: "काजू", Vanilla: "वनीला", "Betel Vine (Paan)": "पान", "Tapioca (Cassava)": "टैपिओका (कसावा)",
    },
  ...
  te: {
    ...
    cropNames: {
      ...
      Tomato: "టమాటా", Potato: "బంగాళాదుంప", Onion: "ఉల్లిపాయ", "Brinjal (Eggplant)": "వంకాయ", "Chilli (Green & Red)": "మిరపకాయ", "Okra (Bhindi/Lady Finger)": "బెండకాయ", Cabbage: "క్యాబేజీ", Cauliflower: "గోబీ", Carrot: "క్యారెట్", Radish: "ముల్లంగి", "Spinach (Palak)": "పాలకూర", "Bottle Gourd (Lauki)": "సొరకాయ", "Bitter Gourd (Karela)": "కాకరకాయ", "Ridge Gourd (Turai)": "బీరకాయ", Pumpkin: "గుమ్మడికాయ", Cucumber: "దోసకాయ", "French Beans": "ఫ్రెంచ్ బీన్స్", "Drumstick (Moringa)": "మునగ", "Sweet Potato": "చిలగడదుంప", Lettuce: "లెట్యూస్", Broccoli: "బ్రోకోలి", "Capsicum (Bell Pepper)": "క్యాప్సికం", Beetroot: "బీట్‌రూట్", "Snake Gourd": "పొట్లకాయ", "Ash Gourd": "బూడిదగుమ్మడి", "Cluster Bean (Guar)": "గోరుచిక్కుడు", "Taro (Arbi)": "చామదుంప",
      Mango: "మామిడి", Banana: "అరటి", Papaya: "బొప్పాయి", Guava: "జామ", Pomegranate: "దానిమ్మ", Grapes: "ద్రాక్ష", Apple: "ఆపిల్", "Orange (Nagpur/Kinnow)": "నారింజ", "Lemon/Lime": "నిమ్మ", Watermelon: "పుచ్చకాయ", "Sapota (Chikoo)": "సపోట", Jackfruit: "పనస", Pineapple: "అనాస", Strawberry: "స్ట్రాబెర్రీ", Litchi: "లీచీ", "Amla (Indian Gooseberry)": "ఉసిరి", "Dragon Fruit": "డ్రాగన్ ఫ్రూట్",
      "Turmeric (Haldi)": "పసుపు", "Ginger (Adrak)": "అల్లం", "Garlic (Lehsun)": "వెల్లుల్లి", "Coriander (Dhaniya)": "ధనియాలు", "Cumin (Jeera)": "జీలకర్ర", "Fenugreek (Methi)": "మెంతులు", "Black Pepper": "నల్లమిరియాలు", Cardamom: "ఏలకులు", Clove: "లవంగాలు", Cinnamon: "దాల్చిన", "Fennel (Saunf)": "సోంపు", Saffron: "కుంకుమపువ్వు",
      "Cotton (Kapas)": "పత్తి", Sugarcane: "చెరకు", Tobacco: "పొగాకు", Jute: "జనపనార",
      Tea: "తేయాకు", Coffee: "కాఫీ", Rubber: "రబ్బరు", Coconut: "కొబ్బరి", "Oil Palm": "ఆయిల్ పామ్", "Arecanut (Supari)": "పోక", Cocoa: "కోకో", Cashew: "జీడిపప్పు", Vanilla: "వెనిల్లా", "Betel Vine (Paan)": "తమలపాకు", "Tapioca (Cassava)": "టాపియోకా",
    },
  ...
  ta: {
    ...
    cropNames: {
      ...
      Mango: "மாம்பழம்", Banana: "வாழைப்பழம்", Papaya: "பப்பாளி", Guava: "கொய்யா", Pomegranate: "மாதுளை", Grapes: "திராட்சை", Apple: "ஆப்பிள்", "Orange (Nagpur/Kinnow)": "ஆரஞ்சு", "Lemon/Lime": "எலுமிச்சை", Watermelon: "தர்பூசணி", "Sapota (Chikoo)": "சப்போட்டா", Jackfruit: "பலாப்பழம்",
      "Turmeric (Haldi)": "மஞ்சள்", "Ginger (Adrak)": "இஞ்சி", "Garlic (Lehsun)": "பூண்டு", "Coriander (Dhaniya)": "கொத்தமல்லி", "Cumin (Jeera)": "சீரகம்", "Fenugreek (Methi)": "வெந்தயம்", "Black Pepper": "மிளகு", Cardamom: "ஏலக்காய்",
      "Cotton (Kapas)": "பருத்தி", Sugarcane: "கரும்பு", Tobacco: "புகையிலை", Jute: "சணல்",
      Tea: "தேயிலை", Coffee: "காபி", Rubber: "ரப்பர்", Coconut: "தேங்காய்",
    },
  ...
  kn: {
    ...
    cropNames: {
      ...
      Mango: "ಮಾವಿನಹಣ್ಣು", Banana: "ಬಾಳೆಹಣ್ಣು", Papaya: "ಪಪ್ಪಾಯ", Guava: "ಸೀಬೆಹಣ್ಣು", Pomegranate: "ದಾಳಿಂಬೆ", Grapes: "ದ್ರಾಕ್ಷಿ", Apple: "ಸೇಬು",
      "Turmeric (Haldi)": "ಅರಿಶಿನ", "Ginger (Adrak)": "ಶುಂಠಿ", "Garlic (Lehsun)": "ಬೆಳ್ಳುಳ್ಳಿ", "Coriander (Dhaniya)": "ಕೊತ್ತಂಬರಿ", "Cumin (Jeera)": "ಜೀರಿಗೆ",
      "Cotton (Kapas)": "ಹತ್ತಿ", Sugarcane: "ಕಬ್ಬು", Tea: "ಚಹಾ", Coffee: "ಕಾಫಿ", Coconut: "ತೆಂಗಿನಕಾಯಿ",
    },
  ...
  ml: {
    ...
    cropNames: {
      ...
      Mango: "മാങ്ങ", Banana: "വാഴപ്പഴം", Coconut: "തേങ്ങ", "Turmeric (Haldi)": "മഞ്ഞൾ", "Ginger (Adrak)": "ഇഞ്ചി", "Black Pepper": "കുരുമുളക്", Cardamom: "ഏലക്ക", Tea: "ചായ", Coffee: "കാപ്പി", Rubber: "റബ്ബർ",
    },
  ...
  mr: {
    ...
    cropNames: {
      ...
      Mango: "आंबा", Banana: "केळे", "Turmeric (Haldi)": "हळद", "Ginger (Adrak)": "आले", "Garlic (Lehsun)": "लसूण",
      "Cotton (Kapas)": "कापूस", Sugarcane: "ऊस", Tea: "चहा", Coffee: "कॉफी", Coconut: "नारळ",
    },
  ...
  bn: {
    ...
    cropNames: {
      ...
      Mango: "আম", Banana: "কলা", "Turmeric (Haldi)": "হলুদ", "Ginger (Adrak)": "আদা",
      Jute: "পাট", Tea: "চা", Sugarcane: "আখ",
    },
  ...
  gu: {
    ...
    cropNames: {
      ...
      Mango: "કેરી", Banana: "કેળા", "Turmeric (Haldi)": "હળદર", "Ginger (Adrak)": "આદું", Coconut: "નાળિયેર",
    },
